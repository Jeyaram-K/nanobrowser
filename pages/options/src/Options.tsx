...
import { FiSettings, FiCpu, FiShield, FiTrendingUp, FiHelpCircle, FiBookOpen } from 'react-icons/fi';
...
type TabTypes = 'general' | 'models' | 'firewall' | 'skills' | 'analytics' | 'help';

const TABS: { id: TabTypes; icon: React.ComponentType<{ className?: string }>; label: string }[] = [
  { id: 'general', icon: FiSettings, label: t('options_tabs_general') },
  { id: 'models', icon: FiCpu, label: t('options_tabs_models') },
  { id: 'firewall', icon: FiShield, label: t('options_tabs_firewall') },
  { id: 'skills', icon: FiBookOpen, label: t('options_tabs_skills') },
...
const Options = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'skills':
        return <SkillsSettings isDarkMode={isDarkMode} />;
      case 'analytics':
